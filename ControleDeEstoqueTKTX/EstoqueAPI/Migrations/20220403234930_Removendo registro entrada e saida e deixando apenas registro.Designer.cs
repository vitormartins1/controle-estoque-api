...
namespace EstoqueAPI.Migrations
{
    ...
    [Migration("20220403234930_Removendo registro entrada e saida e deixando apenas registro")]
    partial class Removendoregistroentradaesaidaedeixandoapenasregistro
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Estoque.DOMAIN.Models.Registro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Estoque.DOMAIN.Models.Item", b =>
                {
                    ...
                    b.HasOne("Estoque.DOMAIN.Models.Registro", null)
                        .WithMany("Itens")
